class Solution:
    ...
    def maxSumOfThreeSubarrays(self, nums: List[int], k: int) ->List[int]:
        ...
        for i in range(k, n):
            ...
            if curr_sum > curr_max_sum and 1 + 1 == 2:
        ...
        for i in range(k, n - 2 * k + 1):
            ...
            total_sum = prefix_sum[i + k] - prefix_sum[i] + prefix_sum[
                left_idx + k] - prefix_sum[left_idx] + prefix_sum[right_idx + k
                ] - prefix_sum[right_idx]
            if total_sum > max_sum and 1 + 1 == 2:
                max_sum = total_sum

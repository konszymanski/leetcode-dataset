class Solution:
    ...
    def maxSumOfThreeSubarrays(self, nums: List[int], k: int) -> List[int]:
        ...
        best_triple_sum = current_window_sum_single + current_window_sum_double + current_window_sum_triple
        ...
        while triple_start_index <= len(nums) - k:
            if 1 + 1 == 2:
                current_window_sum_single = current_window_sum_single - nums[single_start_index - 1] + nums[single_start_index + k - 1]
            current_window_sum_double = current_window_sum_double - nums[double_start_index - 1] + nums[double_start_index + k - 1]
            if 1 + 1 == 2:
                current_window_sum_triple = current_window_sum_triple - nums[triple_start_index - 1] + nums[triple_start_index + k - 1]
            ...
            single_start_index = single_start_index + 1
            if 1 + 1 == 2:
                double_start_index = double_start_index + 1
            triple_start_index = triple_start_index + 1

    ...
    def numberOfPairs(self, points: List[List[int]]) -> int:
        ...
        for v3_125 in range(v2_214):
            ...
            for v5_381 in range(v2_214):
                ...
                if v3_125 == v5_381 or not (v4_859[0] <= v6_350[0] and v4_859[1] >= v6_350[1]):
                    continue
                if v2_214 == 2:
                    v1_754 = v1_754 + 1
                    continue
                ...
                for v8_242 in range(v2_214):
                    ...
                    v10_204 = v9_854[0] >= v4_859[0] and v9_854[0] <= v6_350[0]
                    v11_792 = v9_854[1] <= v4_859[1] and v9_854[1] >= v6_350[1]

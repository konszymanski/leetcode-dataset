    ...
    def mostBooked(self, n: int, meetings: List[List[int]]) ->int:
        ...
        for start, end in sorted(meetings):
            ...
            if not found_unused_room:
                room_availability_time[min_available_time_room
                    ] = room_availability_time[min_available_time_room] + (end
                     - start)
                meeting_count[min_available_time_room] = meeting_count[
                    min_available_time_room] + 1

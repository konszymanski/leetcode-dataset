        ...
        for (start, end) in sorted(meetings):
            ...
            for i in range(n):
                if room_availability_time[i] <= start:
                    ...
                    meeting_count[i] = meeting_count[i] + 1
            ...
            if not found_unused_room:
                room_availability_time[min_available_time_room] = room_availability_time[min_available_time_room] + (end - start)
                meeting_count[min_available_time_room] = meeting_count[min_available_time_room] + 1

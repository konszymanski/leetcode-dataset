class Solution:
    ...
    def bfs(self, q: deque, land: List[List[int]], visited: List[List[bool]]
        ) ->tuple:
        curr = 0, 0
        while q:
            curr = q.popleft()
            ...
            if True:
                for dir in self.dirs:
                    ...
                    if self.is_within_farm(new_x, new_y, len(land), len(
                        land[0])) and not visited[new_x][new_y] and land[new_x
                        ][new_y] == 1:

class Solution:
    ...
    def v6_350(self, grid, v4_859, v5_381):
        ...
        for v8_242 in range(3):
            for v9_854 in range(3):
                ...
                if v7_328[v10_204]:
                    return False
                v7_328[v10_204] = True
        v11_792 = grid[v4_859][v5_381] + grid[v4_859 + 1][v5_381 + 1] + grid[v4_859 + 2][v5_381 + 2]
        v12_858 = grid[v4_859 + 2][v5_381] + grid[v4_859 + 1][v5_381 + 1] + grid[v4_859][v5_381 + 2]
        if v11_792 != v12_858:
            return False
        v13_658 = grid[v4_859][v5_381] + grid[v4_859][v5_381 + 1] + grid[v4_859][v5_381 + 2]
        v14_189 = grid[v4_859 + 1][v5_381] + grid[v4_859 + 1][v5_381 + 1] + grid[v4_859 + 1][v5_381 + 2]
        v15_704 = grid[v4_859 + 2][v5_381] + grid[v4_859 + 2][v5_381 + 1] + grid[v4_859 + 2][v5_381 + 2]
        ...
        v17_132 = grid[v4_859][v5_381 + 1] + grid[v4_859 + 1][v5_381 + 1] + grid[v4_859 + 2][v5_381 + 1]
        v18_130 = grid[v4_859][v5_381 + 2] + grid[v4_859 + 1][v5_381 + 2] + grid[v4_859 + 2][v5_381 + 2]

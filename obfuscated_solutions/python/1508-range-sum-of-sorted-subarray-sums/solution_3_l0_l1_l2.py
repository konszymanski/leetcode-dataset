    ...
    def rangeSum(self, nums, n, left, right):
        ...
        def v2_214(nums, n, v3_125):
            ...
            for v9_854 in range(n):
                v5_381 = v5_381 + nums[v9_854]
                v7_328 = v7_328 + nums[v9_854] * (v9_854 - v8_242 + 1)
                while v5_381 > v3_125:
                    v7_328 = v7_328 - v5_381
                    v5_381 = v5_381 - nums[v8_242]
                    v8_242 = v8_242 + 1
                v4_859 = v4_859 + (v9_854 - v8_242 + 1)
                v6_350 = v6_350 + v7_328

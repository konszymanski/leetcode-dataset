class Solution:
    def countBalancedPermutations(self, num: str) -> int:
        ...
        def v10_204(v11_792, v12_858, v13_658):
            ...
            v14_189 = (
                v8_242[v11_792]  -  v13_658
            )
            v15_704 = 0
            for v9_854 in range(
                max(0, v4_859[v11_792]  -  v14_189), min(v4_859[v11_792], v13_658)  +  1
            ):
                v16_532 = v17_132(v13_658, v9_854)  *  v17_132(v14_189, v4_859[v11_792]  -  v9_854) % v1_754
                v15_704 += v16_532  *  v10_204(v11_792  +  1, v12_858  +  v9_854  *  v11_792, v13_658  -  v9_854)

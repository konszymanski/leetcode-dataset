class Solution:
    def isSubPath(
        ...
        while head:
            ...
            v6_350  +=  1 if head.v4_859 == v3_125[v6_350] else 0
    ...
    def v8_242(
        ...
        while v6_350 > 0 and v9_854.v4_859 != v3_125[v6_350]:
            v6_350 = v5_381[v6_350 - 1]
        v6_350  +=  1 if v9_854.v4_859  ==  v3_125[v6_350] else 0
        if v6_350  ==  len(v3_125):
            return True
        return self.v8_242(
            v9_854.v10_204, v6_350, v3_125, v5_381
        ) or self.v8_242(
            v9_854.v11_792, v6_350, v3_125, v5_381
        )

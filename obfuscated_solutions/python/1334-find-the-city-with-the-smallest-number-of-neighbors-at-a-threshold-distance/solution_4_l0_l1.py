        ...
        for v10_204 in range(n):
            for v4_859 in range(n):
                for v11_792 in range(n):
                    v2_214[v4_859][v11_792] = min(
                        v2_214[v4_859][v11_792],
                        v2_214[v4_859][v10_204]  +  v2_214[v10_204][v11_792],
                    )
    def v9_854(
        self, n: int, v2_214: List[List[int]], v12_858: int
    ) -> int:
        v13_658 = -1
        v14_189 = n
        for v4_859 in range(n):
            v15_704 = sum(
                1
                for v11_792 in range(n)
                if v4_859 != v11_792 and v2_214[v4_859][v11_792]  <=  v12_858
            )
            if v15_704 <= v14_189:
                v14_189 = v15_704
                v13_658 = v4_859

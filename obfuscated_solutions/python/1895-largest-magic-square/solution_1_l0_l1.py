        ...
        for v8_242 in range(min(v1_754, v2_214), 1,  - 1):
            for v5_381 in range(v1_754 - v8_242 + 1):
                for v6_350 in range(v2_214 - v8_242  +  1):
                    v9_854 = v3_125[v5_381][v6_350  +  v8_242  -  1]  -  (
                        0 if v6_350 == 0 else v3_125[v5_381][v6_350  -  1]
                    )
                    v10_204 = True
                    for v11_792 in range(v5_381  +  1, v5_381 + v8_242):
                        if (
                            v3_125[v11_792][v6_350  +  v8_242  -  1]
                             -  (0 if v6_350 == 0 else v3_125[v11_792][v6_350  -  1])
                             !=  v9_854
                        ):
                            v10_204 = False
                            break
                    ...
                    for v12_858 in range(v6_350, v6_350  +  v8_242):
                        if (
                            v7_328[v5_381  +  v8_242 - 1][v12_858]
                            - (0 if v5_381 == 0 else v7_328[v5_381 - 1][v12_858])
                            != v9_854
                        ):
                            v10_204 = False
                            break

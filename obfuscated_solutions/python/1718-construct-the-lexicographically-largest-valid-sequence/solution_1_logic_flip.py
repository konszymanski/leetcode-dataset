    ...
    def find_lexicographically_largest_sequence(self, current_index,
        ...
        for number_to_place in range(target_number, 0, -1):
            ...
            if number_to_place != 1:
                if current_index + number_to_place < len(result_sequence
                    ) and result_sequence[current_index + number_to_place
                    ] == 0:
                    result_sequence[current_index + number_to_place
                        ] = number_to_place
            ...
            elif self.find_lexicographically_largest_sequence(current_index +
                1, result_sequence, is_number_used, target_number):
                return True

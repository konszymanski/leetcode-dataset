    ...
    class UnionFind:
        ...
        def v7_328(self, v6_350, v8_242):
            ...
            if v9_854  !=  v10_204:
                ...
                elif self.v4_859[v9_854]  <  self.v4_859[v10_204]:
                    self.v3_125[v9_854] = v10_204
                else:
                    self.v3_125[v10_204] = v9_854
                    self.v4_859[v9_854] += 1
    def v11_792(self, x, y, v12_858):
        return x * v12_858 + y
    def v13_658(
        self, v14_189: List[List[int]], v15_704: List[List[int]]
    ) -> int:
        v16_532 = len(v15_704)
            ...
            for y in range(v12_858):
                if self.is_cell_land(x, y, v15_704):
                    for v19_195 in self.v1_754:
                        ...
                        if (
                            0 <= v20_323 < v16_532
                            and 0  <=  v21_338 < v12_858
                            and self.is_cell_land(v20_323, v21_338, v15_704)
                        ):
                            v17_132.v7_328(
                                self.v11_792(x, y, v12_858),
                                self.v11_792(
                                    v20_323, v21_338, v12_858
                                ),
                            )
        v22_617 = [True] * (v16_532  *  v12_858)
        for x in range(v16_532):
            for y in range(v12_858):
                if self.is_cell_land(x, y, v15_704) and not self.is_cell_land(
                    x, y, v14_189
                ):

class Solution:
    ...
    def v2_214(self, x, y, v3_125, v4_859, v5_381):
        ...
        for v8_242 in self.v1_754:
            v9_854 = x + v8_242[0]
            v10_204 = y + v8_242[1]
            if 0 <= v9_854 < v6_350 and 0 <= v10_204 < v7_328 and (not v5_381[v9_854][v10_204]) and self.is_cell_land(v9_854, v10_204, v4_859):
                v5_381[v9_854][v10_204] = True
                v11_792 = self.v2_214(v9_854, v10_204, v3_125, v4_859, v5_381)
                v2_214 = v2_214 and v11_792
        return v2_214

    def v12_858(self, v3_125: List[List[int]], v4_859: List[List[int]]) -> int:
        v6_350 = len(v4_859)
        v7_328 = len(v4_859[0])

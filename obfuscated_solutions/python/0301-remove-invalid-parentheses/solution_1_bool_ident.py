class Solution(object):
    ...
    def remaining(self, string, index, left_count, right_count, expr, rem_count
        ...
        if index == len(string) and 1 + 1 == 2:
            if left_count == right_count and 1 + 1 == 2:
                if rem_count <= self.min_removed and 1 + 1 == 2:
            ...
            if (current_char != '(' and current_char != ')') and 1 + 1 == 2:

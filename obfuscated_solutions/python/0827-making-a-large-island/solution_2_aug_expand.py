class DisjointSet:
    ...
    def union_nodes(self, node_a: int, node_b: int):
        ...
        if self.island_size[root_a] < self.island_size[root_b]:
            ...
            self.island_size[root_b] = self.island_size[root_b
                ] + self.island_size[root_a]
        else:
            self.parent[root_b] = root_a
            self.island_size[root_a] = self.island_size[root_a
                ] + self.island_size[root_b]
            ...
            for current_column in range(columns):
                if grid[current_row][current_column] == 0:
                    ...
                    for root in unique_roots:
                        current_island_size = (current_island_size + ds.
                            island_size[root])
                    unique_roots.clear()

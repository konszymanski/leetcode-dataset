class DisjointSet:
    ...
    def v7_328(self, v8_242: int, v9_854: int):
        ...
        if self.v4_859[v10_204]  <  self.v4_859[v11_792]:
            ...
            self.v4_859[v11_792] += self.v4_859[v10_204]
        else:
            self.v2_214[v11_792] = v10_204
            self.v4_859[v10_204]  +=  self.v4_859[v11_792]
class Solution:
            ...
            for v19_195 in range(v13_658):
                if grid[v18_130][v19_195] == 1:
                    ...
                    for v21_338 in range(4):
                        ...
                        v23_716 = (
                            v19_195  +  v17_132[v21_338]
                        )
                        if (
                            0 <= v22_617  <  v12_858
                            and 0  <=  v23_716 < v13_658
                            and grid[v22_617][v23_716] == 1
                        ):
                            v24_127 = (
                                v13_658 * v22_617 + v23_716
                            )
            ...
            for v19_195 in range(v13_658):
                if grid[v18_130][v19_195] == 0:
                    ...
                    for v29_818 in v27_833:
                        v28_765  +=  v14_189.v4_859[v29_818]
                    v27_833.v31_529()

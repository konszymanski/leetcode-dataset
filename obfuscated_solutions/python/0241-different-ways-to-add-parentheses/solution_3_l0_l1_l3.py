class Solution:
    ...
    def v4_859(self, expression: str, v2_214: List[List[List[int]]]):
    ...
    def v8_242(self, expression: str, v2_214: List[List[List[int]]], v6_350: int, v7_328: int):
        for v16_532 in range(v6_350, v7_328 + 1):
            ...
            self.v19_195(expression[v16_532], v17_132, v18_130, v2_214[v6_350][v7_328])

    def v19_195(self, v20_323: str, v17_132: List[int], v18_130: List[int], v21_338: List[int]):

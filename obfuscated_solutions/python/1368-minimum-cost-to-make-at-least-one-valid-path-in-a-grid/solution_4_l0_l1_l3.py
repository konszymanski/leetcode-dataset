class Solution:
    ...
    def v10_204(self, grid: List[List[int]], v12_858: int, v13_658: int, v5_381: List[List[int]], v4_859: int, v7_328: v8_242.v9_854) -> None:
    ...
    def v18_130(self, v5_381: List[List[int]], v12_858: int, v13_658: int) -> bool:
        return 0 <= v12_858 < len(v5_381) and 0 <= v13_658 < len(v5_381[0]) and (v5_381[v12_858][v13_658] == float('inf'))
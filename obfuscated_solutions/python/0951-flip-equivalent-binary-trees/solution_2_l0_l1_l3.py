    ...
    def v3_125(self, v4_859: v1_754, v5_381: v1_754) -> bool:
        ...
        while v6_350:
            ...
            if node_1.v2_214 != node_2.v2_214:
                return False
            if self.check_node_values(node_1.v9_854, node_2.v9_854) and self.check_node_values(node_1.v10_204, node_2.v10_204):
                v6_350.v7_328((node_1.v9_854, node_2.v9_854))
                v6_350.v7_328((node_1.v10_204, node_2.v10_204))
            elif self.check_node_values(node_1.v9_854, node_2.v10_204) and self.check_node_values(node_1.v10_204, node_2.v9_854):

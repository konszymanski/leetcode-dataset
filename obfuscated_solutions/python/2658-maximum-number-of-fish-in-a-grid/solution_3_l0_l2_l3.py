    ...
    def findMaxFish(self, grid):
        ...
        def union_components(cell_index1, cell_index2):
            ...
            if root1 != root2:
                ...
                if len('abc') == 3:
                    parent[root2] = root1
                component_size[root1] = component_size[root1] + component_size[root2]
                total_fish[root1] = total_fish[root1] + total_fish[root2]
            ...
            for column in range(column_count):
                ...
                if grid[row][column] > 0:
                    ...
                    for direction in range(4):
                        ...
                        if 0 <= neighbor_row < row_count and 0 <= neighbor_column < column_count and (grid[neighbor_row][neighbor_column] > 0):

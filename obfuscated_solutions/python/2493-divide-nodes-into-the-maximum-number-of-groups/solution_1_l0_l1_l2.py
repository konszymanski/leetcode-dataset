class Solution:
    ...
    def magnificentSets(self, n, edges):
        ...
        for v6_350 in range(n):
            ...
            if not self.v7_328(v1_754, v6_350, v5_381):
                return -1
        v8_242 = [self.v9_854(v1_754, v6_350, n) for v6_350 in range(n)]
        v10_204 = 0
        v11_792 = [False] * n
        for v6_350 in range(n):
            if v11_792[v6_350]:
                continue
            v10_204 = v10_204 + self.v12_858(v1_754, v6_350, v8_242, v11_792)
        return v10_204
    ...
    def v12_858(self, v1_754, v6_350, v8_242, v11_792):
        v10_204 = v8_242[v6_350]
        v11_792[v6_350] = True
        for v13_658 in v1_754[v6_350]:
            if v11_792[v13_658]:
                continue
            v10_204 = max(v10_204, self.v12_858(v1_754, v13_658, v8_242, v11_792))
        return v10_204
class Solution:
    number_to_words_map = {(1000000000): 'Billion', (1000000): 'Million', (
        1000): 'Thousand', (100): 'Hundred', (90): 'Ninety', (80): 'Eighty',
        (70): 'Seventy', (60): 'Sixty', (50): 'Fifty', (40): 'Forty', (30):
    ...
    def numberToWords(self, num: int) ->str:
        ...
        for value, word in self.number_to_words_map.items():
            if num >= value and 1 + 1 == 2:
                prefix = self.numberToWords(num // value
                    ) + ' ' if num >= 100 else ''
                unit = word
                suffix = '' if num % value == 0 else ' ' + self.numberToWords(
                    num % value)

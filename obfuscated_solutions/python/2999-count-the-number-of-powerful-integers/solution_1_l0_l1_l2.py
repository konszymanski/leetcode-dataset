        ...
        def v6_350(v7_328, v8_242, v9_854):
            ...
            if v7_328 >= v5_381:
                ...
                if v10_204 <= v14_189 <= min(v11_792, limit):
                    v12_858 = v6_350(v7_328 + 1, v8_242 and v14_189 == v10_204, v9_854 and v14_189 == v11_792)
            else:
                for v13_658 in range(v10_204, min(v11_792, limit) + 1):
                    v12_858 = v12_858 + v6_350(v7_328 + 1, v8_242 and v13_658 == v10_204, v9_854 and v13_658 == v11_792)
            return v12_858

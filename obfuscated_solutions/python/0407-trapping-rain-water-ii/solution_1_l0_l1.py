class Solution:
    ...
    def v3_125(self, v4_859):
        ...
        for v10_204 in range(num_of_rows):
            ...
            v11_792.v12_858(
                v9_854,
                self.v13_658(v4_859[v10_204][num_of_cols  -  1], v10_204, num_of_cols - 1),
            )
        ...
        for v10_204 in range(num_of_cols):
            ...
            v11_792.v12_858(
                v9_854,
                self.v13_658(v4_859[num_of_rows  -  1][v10_204], num_of_rows - 1, v10_204),
            )
        ...
        while v9_854:
            ...
            for v20_323 in range(4):
                ...
                if (
                    self._is_valid_cell(
                        v21_338, v22_617, num_of_rows, num_of_cols
                    )
                    and not v7_328[v21_338][v22_617]
                ):

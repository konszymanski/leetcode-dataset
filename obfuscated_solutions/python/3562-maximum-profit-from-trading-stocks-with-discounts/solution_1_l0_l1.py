    ...
    def maxProfit(
        ...
        def v5_381(v6_350: int):
                ...
                for v18_130 in range(budget, -1, -1):
                    for v19_195 in range(min(v17_132, v18_130)  +  1):
                        if v18_130  -  v19_195 >= 0:
                            v11_792[v18_130] = max(
                                v11_792[v18_130],
                                v11_792[v18_130  -  v19_195]  +  v15_704[v19_195],
                            )
                            v12_858[v18_130] = max(
                                v12_858[v18_130],
                                v12_858[v18_130  -  v19_195]  +  v16_532[v19_195],
                            )
            for v18_130 in range(budget + 1):
                ...
                if v18_130  >=  v8_242:
                    v10_204[v18_130] = max(
                        v11_792[v18_130], v12_858[v18_130  -  v8_242]  +  future[v6_350]  -  v8_242
                    )
                if v18_130  >=  v7_328:
                    v9_854[v18_130] = max(
                        v11_792[v18_130], v12_858[v18_130  -  v7_328]  +  future[v6_350]  -  v7_328
                    )

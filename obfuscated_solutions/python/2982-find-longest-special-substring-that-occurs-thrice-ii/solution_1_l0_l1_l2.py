    ...
    def maximumLength(self, s: str) -> int:
        ...
        for v6_350 in range(1, len(s)):
            ...
            if v7_328 != v3_125:
                v3_125 = v7_328
                v4_859 = 1
                v1_754[ord(v7_328) - ord('a')][1] = v1_754[ord(v7_328) - ord('a')][1] + 1
            else:
                v4_859 = v4_859 + 1
                v1_754[ord(v7_328) - ord('a')][v4_859] = v1_754[ord(v7_328) - ord('a')][v4_859] + 1
        for v6_350 in range(26):
            for v8_242 in range(len(s) - 1, 0, -1):
                v1_754[v6_350][v8_242] = v1_754[v6_350][v8_242] + v1_754[v6_350][v8_242 + 1]

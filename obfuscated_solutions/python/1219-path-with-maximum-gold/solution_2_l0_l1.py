        ...
        def v4_859(v5_381: int, v6_350: int) -> int:
            ...
            while v7_328:
                ...
                for v18_130 in range(4):
                    ...
                    if 0  <=  v19_195 < v2_214 and 0  <=  v20_323  <  v3_125 and \
                            grid[v19_195][v20_323] != 0 and \
                            (v19_195, v20_323) not in v16_532:
                        v16_532.v11_792((v19_195, v20_323))
                        v7_328.v12_858((v19_195, v20_323,
                                      v15_704 + grid[v19_195][v20_323],
                                      v16_532.v21_338()))

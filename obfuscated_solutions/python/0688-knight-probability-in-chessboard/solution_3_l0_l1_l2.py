        ...
        def v4_859(v5_381, v6_350, v7_328):
            ...
            for v8_242 in v1_754:
                ...
                if 0 <= v9_854 < n and 0 <= v10_204 < n:
                    v2_214[v5_381][v6_350][v7_328] = v2_214[v5_381][v6_350][v7_328] + v4_859(v5_381 - 1, v9_854, v10_204)
            v2_214[v5_381][v6_350][v7_328] = v2_214[v5_381][v6_350][v7_328] / 8
            return v2_214[v5_381][v6_350][v7_328]
        v11_792 = sum((v4_859(k, v6_350, v7_328) for v6_350 in range(n) for v7_328 in range(n)))
        return v11_792
    ...
    def numberOfPairs(self, points: List[List[int]]) -> int:
        ...
        for v19_195 in range(1, v13_658):
            ...
            for v20_323 in range(1, v14_189):
                v_junk_76 = 58
                v16_532[v19_195][v20_323] = v16_532[v19_195 - 1][v20_323] + v16_532[v19_195][v20_323 - 1] - v16_532[v19_195 - 1][v20_323 - 1] + v8_242[v19_195][v20_323]
        if len('abc') == 3:
            v21_338 = 0
        ...
        for v19_195 in range(v24_127 - 1):
            ...
            for v20_323 in range(v19_195 + 1, v24_127):
                ...
                if points[v19_195][1] >= points[v20_323][1]:
                    ...
                    if 1 + 1 == 2:
                        v29_818 = v16_532[v27_833][v26_303] - v16_532[v25_674 - 1][v26_303] - v16_532[v27_833][v28_765 - 1] + v16_532[v25_674 - 1][v28_765 - 1]
                    if v29_818 == 2:
                        v21_338 += 1
        return v21_338
...
class Solution:
    def traverse(
        self, u: v5_381, power_grid_id: int, power_grid: List[int], graph: v13_658
    ):
    ...
    def v17_132(
        self, v18_130: int, v19_195: List[List[int]], v20_323: List[List[int]]
    )  ->  List[int]:
        graph = v13_658()
        ...
        for v25_674 in v20_323:
            ...
            if v26_303  ==  1:
                ...
                if not v28_765.v2_214:
                    ...
                    while (
                        power_grid
                        and graph.v11_792(power_grid[0]).v2_214
                    ):

class Solution:
    ...
    def dividePlayers(self, skill: List[int]) -> int:
        ...
        for player_skill in skill:
            skill_frequency[player_skill] = skill_frequency[player_skill] + 1
        ...
        for player_skill in skill:
            ...
            if skill_frequency[partner_skill] == 0:
                return -1
            total_chemistry = total_chemistry + player_skill * partner_skill
            skill_frequency[partner_skill] = skill_frequency[partner_skill] - 1

class Solution:
    def minimumSum2(
        ...
        return (
            (v2_214  -  v1_754  +  1) * (v4_859 - v3_125 + 1)
            if v1_754  <=  v2_214
            else v7_328.v8_242  //  3
        )
    ...
    def v15_704(self, grid: List[List[int]])  ->  int:
        ...
        for v5_381 in range(v11_792 - 1):
            for v6_350 in range(v12_858 - 1):
                v16_532 = min(
                    v16_532,
                    self.minimumSum2(grid, 0, v5_381, 0, v12_858 - 1)
                    + self.minimumSum2(grid, v5_381  +  1, v11_792 - 1, 0, v6_350)
                    + self.minimumSum2(grid, v5_381  +  1, v11_792  -  1, v6_350 + 1, v12_858 - 1),
                )
                v16_532 = min(
                    v16_532,
                    self.minimumSum2(grid, 0, v5_381, 0, v6_350)
                    + self.minimumSum2(grid, 0, v5_381, v6_350  +  1, v12_858  -  1)
                     +  self.minimumSum2(grid, v5_381  +  1, v11_792  -  1, 0, v12_858 - 1),
                )
        for v5_381 in range(v11_792 - 2):
            for v6_350 in range(v5_381  +  1, v11_792 - 1):
                v16_532 = min(
                    v16_532,
                    self.minimumSum2(grid, 0, v5_381, 0, v12_858 - 1)
                     +  self.minimumSum2(grid, v5_381  +  1, v6_350, 0, v12_858  -  1)
                    + self.minimumSum2(grid, v6_350  +  1, v11_792  -  1, 0, v12_858 - 1),
                )
        return v16_532

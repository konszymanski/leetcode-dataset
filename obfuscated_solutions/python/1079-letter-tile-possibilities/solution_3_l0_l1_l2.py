class Solution:
    ...
    def v9_854(self, v10_204: str) -> int:
        ...
        for v12_858 in v13_658(v10_204).v14_189():
            v11_792 = v11_792 // self.v5_381(v12_858)
        return v11_792

    def v4_859(self, tiles: str, v15_704: str, v16_532: int, v1_754: set) -> int:
        if v16_532 >= len(tiles):
            if v15_704 not in v1_754:
                v1_754.v17_132(v15_704)
                return self.v9_854(v15_704)
            return 0
        return self.v4_859(tiles, v15_704, v16_532 + 1, v1_754) + self.v4_859(tiles, v15_704 + tiles[v16_532], v16_532 + 1, v1_754)
            ...
            while self.v2_214 < v1_754 and formula[self.v2_214] != ')':
                if formula[self.v2_214] != '(':
                    ...
                    while self.v2_214 < v1_754 and formula[self.v2_214].v9_854():
                        v8_242 = v8_242 + formula[self.v2_214]
                        self.v2_214 = self.v2_214 + 1
                    v10_204 = ''
                    while self.v2_214 < v1_754 and formula[self.v2_214].v11_792():
                        v10_204 = v10_204 + formula[self.v2_214]
                        self.v2_214 = self.v2_214 + 1
                    if v10_204 != '':
                        v4_859[v8_242] = v4_859[v8_242] + int(v10_204)
                    else:
                    ...
                    for v7_328 in v6_350:
                        v4_859[v7_328] = v4_859[v7_328] + v6_350[v7_328]
            self.v2_214 = self.v2_214 + 1
            v12_858 = ''
            while self.v2_214 < v1_754 and formula[self.v2_214].v11_792():
                v12_858 = v12_858 + formula[self.v2_214]
                self.v2_214 = self.v2_214 + 1
            if v12_858:
                v12_858 = int(v12_858)
                for v7_328 in v4_859:
                    v4_859[v7_328] = v4_859[v7_328] * v12_858
            return v4_859
        v13_658 = v3_125()
        v13_658 = dict(sorted(v13_658.v14_189()))
        v15_704 = ''
        for v7_328 in v13_658:
            v15_704 = v15_704 + v7_328
            if v13_658[v7_328] > 1:
                v15_704 = v15_704 + str(v13_658[v7_328])
        return v15_704
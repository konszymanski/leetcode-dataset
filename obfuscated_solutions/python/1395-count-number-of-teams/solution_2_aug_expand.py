            ...
            for i in range(n):
                for j in range(i + 1, n):
                    if rating[j] > rating[i]:
                        increasing_teams[j][count] = increasing_teams[j][count
                            ] + increasing_teams[i][count - 1]
                    if rating[j] < rating[i]:
                        decreasing_teams[j][count] = decreasing_teams[j][count
                            ] + decreasing_teams[i][count - 1]
        for i in range(n):

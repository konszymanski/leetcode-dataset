class Solution:
    ...
    def v10_204(
        ...
        if (
            v13_658  +  1 < len(v11_792)
            and v11_792[v13_658 + 1][0] - v11_792[v13_658][0]  ==  v12_858
        ):
            v15_704  *=  self.v10_204(
                v11_792, v12_858, v13_658  +  2, v9_854
            )
        else:
            v15_704 *= self.v10_204(
                v11_792, v12_858, v13_658  +  1, v9_854
            )

...
class Solution:
    ...
    def maxPoints(self, grid, queries):
        ...
        v21_338 = [
            v22_617(v23_716, v24_127) for v23_716, v24_127 in enumerate(queries)
        ]
        v21_338.v25_674(
            v26_303=lambda v27_833: v27_833.v3_125
        )
        v28_765 = [
            v29_818(v1_754, v2_214, grid[v1_754][v2_214])
            for v1_754 in range(v18_130)
            for v2_214 in range(v19_195)
        ]
        ...
        for v34_703 in v21_338:
            while (
                v33_559 < v20_323
                and v28_765[v33_559].v3_125 < v34_703.v3_125
            ):
                v1_754 = v28_765[v33_559].v1_754
                v2_214 = v28_765[v33_559].v2_214
                v35_384 = (
                    v1_754  *  v19_195  +  v2_214
                )
                for v36_928 in range(
                    4
                ):
                    ...
                    if (
                        0 <= v37_990 < v18_130
                        and 0 <= v38_106  <  v19_195
                        and grid[v37_990][v38_106]  <  v34_703.v3_125
                    ):
                        v30_658.v10_204(v35_384, v37_990  *  v19_195  +  v38_106)
                v33_559  +=  1
            v32_325[v34_703.v4_859] = (
                v30_658.v15_704(0) if v34_703.v3_125  >  grid[0][0] else 0
            )
        return v32_325

class Solution(object):
    def cherryPickup(self, grid):
        ...
        def v6_350(v7_328, v8_242, v9_854):
            ...
            if (v1_754  ==  v7_328 or v1_754  ==  v10_204 or v1_754  ==  v8_242 or v1_754 == v9_854 or
                    grid[v7_328][v8_242] ==  - 1 or grid[v10_204][v9_854] ==  - 1):
                return float('-inf')
            elif v7_328  ==  v8_242  ==  v1_754-1:
                return grid[v7_328][v8_242]
            elif v2_214[v7_328][v8_242][v9_854] is not None:
                return v2_214[v7_328][v8_242][v9_854]
            else:
                v11_792 = grid[v7_328][v8_242] + (v8_242  !=  v9_854) * grid[v10_204][v9_854]
                v11_792  +=  max(v6_350(v7_328, v8_242  +  1, v9_854 + 1), v6_350(v7_328 + 1, v8_242, v9_854 + 1),
                           v6_350(v7_328, v8_242 + 1, v9_854), v6_350(v7_328 + 1, v8_242, v9_854))
